...
eleven_turn_5046 = np.genfromtxt('11_turn_cyclone_5046.csv', delimiter=',', skip_header=1,
                     names=['Time_ms', 'dshot', 'Voltage_V', 'Current_A', 'RPM', 'Thrust_g'])
eleven_turn_5046_6s = np.genfromtxt('11_turn_cyclone_5046 - 6s.csv', delimiter=',', skip_header=1,
                     names=['Time_ms', 'dshot', 'Voltage_V', 'Current_A', 'RPM', 'Thrust_g'])
...
eleven_turn_5050 = np.genfromtxt('11_turn_cyclone_5050.csv', delimiter=',', skip_header=1,
                     names=['Time_ms', 'dshot', 'Voltage_V', 'Current_A', 'RPM', 'Thrust_g'])
eleven_turn_5050_6s = np.genfromtxt('11_turn_cyclone_5050 - 6s.csv', delimiter=',', skip_header=1,
                     names=['Time_ms', 'dshot', 'Voltage_V', 'Current_A', 'RPM', 'Thrust_g'])

## KV plot
fig = plt.figure() 
ax1 = fig.add_subplot(111)
ax1.title.set_text('6s')
#ax2 = ax1.twinx()
#ax3 = ax1.twinx()
#ax3.spines["right"].set_position(("axes", 1.2))
#fig.subplots_adjust(right=0.75)

#ax3.plot(eleven_turn_5046['Time_ms'], eleven_turn_5046['dshot'], color='y', label='dshot')
...
ax1.plot(eleven_turn_5046['RPM'], eleven_turn_5046['Thrust_g'] , color='b', label='11 turn 5046 4s')
ax1.plot(eleven_turn_5046_6s['RPM'], eleven_turn_5046_6s['Thrust_g'] , color='g', label='11 turn 5046 6s')
ax1.plot(eleven_turn_5050['RPM'], eleven_turn_5050['Thrust_g'] , color='r', label='11 turn 5050 4s')
ax1.plot(eleven_turn_5050_6s['RPM'], eleven_turn_5050_6s['Thrust_g'] , color='orange', label='11 turn 5050 6s')
ax1.set_xlabel('RPM')
ax1.set_xlim([0, 30000])
ax1.set_ylabel('Thrust_g')
ax1.set_ylim([0, 1500])
ax1.legend()
